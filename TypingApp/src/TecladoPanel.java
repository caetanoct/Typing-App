...
public class TecladoPanel extends JPanel {
	private static final String[] botoesLinha1 = { 
			...
			"9", "0", "-", "+",
			"Backspace" };
private static final String[] botoesLinha2 = { "Tab", "Q", "W", "E",
		"R", "T", "Y", "U",
		"I", "O", "P", "[", "]",
	"\\" };
...
public static final int[] keyCodesLinha1 = {
		222, 49, 50, 51, 52, 53, 54, 55, 56, 57, 48, 45, 61, 8};
public static final int[] keyCodesLinha2 = {
		9, 81, 87, 69, 82, 84, 89, 85, 73, 79, 80, 129, 91, 93 };
public static final int[] keyCodesLinha3 = {
		20, 65, 83, 68, 70, 71, 72, 74, 75, 76, 0, 131, 10};
public static final int[] keyCodesLinha4 = {
		16, 90, 88, 67, 86, 66, 78, 77, 44, 46, 59, 38 };
public static final int[] keyCodesLinha5 = {
		32, 37, 40, 39};
public static final int[] KeyCodesDoTecladoVirtual = {222, 49, 50,
		51, 52, 53, 54, 55, 56, 57, 48, 45, 61, 8,9, 81, 87,
		69, 82, 84, 89, 85, 73, 79, 80, 129, 91, 93,20, 65, 83, 68, 70, 71, 72, 74, 75, 76, 0, 131, 10,
		16, 90, 88, 67, 86, 66, 78, 77, 44, 46, 59, 38, 
		32, 37, 40, 39};
